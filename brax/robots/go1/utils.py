...
class Go1Utils:
    ...
    """constant: the joint angles for a single leg while standing"""

    ALL_STANDING_JOINT_ANGLES = jp.tile(STANDING_JOINT_ANGLES, 4)
    """constant: the joint angles for all legs while standing"""
    ...
    def standing_foot_positions() -> jp.ndarray:
        ...
        return jp.concatenate([
            Go1Utils.forward_kinematics('FR', Go1Utils.STANDING_JOINT_ANGLES),
            Go1Utils.forward_kinematics('FL', Go1Utils.STANDING_JOINT_ANGLES),
            Go1Utils.forward_kinematics('RR', Go1Utils.STANDING_JOINT_ANGLES),
            Go1Utils.forward_kinematics('RL', Go1Utils.STANDING_JOINT_ANGLES),
        ])
